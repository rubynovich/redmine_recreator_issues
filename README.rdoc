...
This plugin add new tasks for re-create issues (with reset old status and recalculation start_date and due_date, without attachments). Useful for repetitive issues.
